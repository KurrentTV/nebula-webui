...
var baseURL = 'https://dev.iohub.tv/';
...
(function(window, document, $, undefined) {
    ...
    var chartState = function(element) {
        ...
        var showRendering = function() {
            ...
            showMessageIcon(icon + ' nebula' + invisibleSearchableText());
        };

        var showLoading = function() {
            if(that.chart_created === false) {
                showMessageIcon(NETDATA.icons.loading + ' nebula');
                return true;
            }
            return false;
        };
        ...
        this.updateChart = function(callback) {
            ...
            if(this.debug === true)
                ...
                var _url = this.data_url.split('/');
                var u = this.data_url.replace(_url[0],"");		
            this.xhr = $.ajax( {
                url: baseURL + "api/getChartData",
                type:"get",
